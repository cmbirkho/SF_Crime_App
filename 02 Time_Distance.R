...
# For all time/distance calculations we order the incidents in the order they
# happened based on incident_datetime and then calculate distance/time to the next incident
